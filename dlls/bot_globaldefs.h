...
#define MSG_DOD_CLASS_SELECT_AX			4
#define MSG_DOD_CLASS_SELECT_AL			5
#define MSG_DOD_CLASS_SELECT_AX_PARA	4
#define MSG_DOD_CLASS_SELECT_AL_PARA	5
#define MSG_DOD_WPN_SELECT_SERGEANT		6
#define MSG_DOD_WPN_SELECT_MACHINE		7
#define MSG_DOD_WPN_SELECT_GRENADIER	8
#define MSG_DOD_WPN_SELECT_RIFLEMAN		9
#define MSG_DOD_WPN_SELECT_FG42			10
